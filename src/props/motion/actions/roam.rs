...
impl Roam {
    ...
    // original version of this function before the control flow was refactored to account for a
    // very nasty `goto` generated by the decompiler
    // /// offset: 0x31a30
    // fn update_forward_pos(&mut self, prop: &mut Prop, unk_flag: bool, raycast_ref: RaycastRef) -> bool {
